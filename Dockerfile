...
RUN \
    ...
    GOPATH=/app /usr/local/go/bin/go get -t github.com/die-net/fotomat/cmd/fotomat github.com/die-net/fotomat/imager && \
    GOPATH=/app /usr/local/go/bin/go test github.com/die-net/fotomat/cmd/fotomat github.com/die-net/fotomat/imager && \
